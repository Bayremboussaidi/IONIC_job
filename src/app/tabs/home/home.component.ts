...
import { JobComponent } from 'src/app/job/job.component'; // Adjust the import path as per your project structure
...
export class HomePage implements OnInit {
  ...
  trackJob(index: number, job: any): number {
    return job.id; // Assuming each job has a unique id property
  }
}